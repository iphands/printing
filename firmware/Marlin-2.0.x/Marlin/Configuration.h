...
#define Z_MIN_ENDSTOP_INVERTING false // FOR bltouch BLTOUCH
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // FOR bltouch BLTOUCH
...
#define XY_PROBE_FEEDRATE (11000)
