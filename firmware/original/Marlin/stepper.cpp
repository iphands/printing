...
//      #endif
  ...
  if (TCNT1 >= OCR1A) TCNT1 = 175; //Marlin glitch fix by jsc, implemented and tested by MG|Josh; added 2/23/2016; see https://github.com/MarlinFirmware/MarlinDev/issues/35 for all the details
}
